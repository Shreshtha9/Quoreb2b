...
export default function Footer() {
  return (
    <footer className="w-full bg-white border-gray-200" role="contentinfo">
      <div className="w-full max-w-[1900px] mx-auto px-4 sm:px-6 lg:px-12 py-12 md:py-20 grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-0 font-quicksand">
        {/* Column 1: Logo + About */}
        <div className="pr-0 md:pr-8">
          <div className="flex items-center gap-2 mb-2">
            <Image 
              src="/images/logo.png" 
              alt="Quore B2B Marketing Logo" 
              width={50} 
              height={40} 
              priority={false}
              loading="lazy"
        ...
        <div className="pl-0 md:pl-4">
          ...
          <ul className="space-y-2 text-sm text-gray-900">
            ...
            <li><Link href="/donotsell" className="hover:text-[#00d8a6] transition">California Do Not Sell My Info</Link></li>
            <li><Link href="/contact" className="hover:text-[#00d8a6] transition">Contact</Link></li>
          </ul>
        </div>
        ...
        <div className="pl-0 md:pl-4">
          ...
          <p className="text-sm text-gray-700 mb-4">
            <Link href="mailto:contactus@quoreb2b.com" className="hover:text-[#00d8a6] transition">Email: contactus@quoreb2b.com</Link>
          </p>
          <p className="text-sm text-gray-700">
            <Link href="tel:+13322310404" className="hover:text-[#00d8a6] transition">Phone: +1 332-231-0404</Link>
          </p>
        </div>
        ...
        <div className="pl-0 md:pl-4">
          ...
          <iframe
            ...
            aria-label="Google Maps location of Quore B2B Marketing"
          ></iframe>
        </div>
      </div>

      {/* Bottom Bar */}
      <div className="relative w-full bg-gradient-to-br from-[#2a2a2a] via-[#333] to-[#1f1f1f] text-[#ffffffcb] text-sm flex flex-col md:flex-row items-center justify-between py-6 px-4 sm:px-6 lg:px-12 rounded-b-xl overflow-hidden group transition-all duration-500 hover:shadow-2xl hover:shadow-[#00d8a6]/20 border-t border-[#404040]">
        ...
        <div className="relative z-10 flex items-center space-x-2 mb-4 md:mb-0">
          <span className="text-[#ffffffcb] group-hover:text-white transition-all duration-300">©</span>
          <Link href="/" className="text-[#00d8a6] font-semibold hover:text-[#00f2b8] transition-colors duration-300 cursor-pointer tracking-wide">
            2025 quoreb2b.com
          </Link>
        ...
        <div className="relative z-10 flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              href="mailto:contact@quoreb2b.com"
