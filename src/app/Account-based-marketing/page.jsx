  ...
  return (
    <>
      <div className="min-h-screen bg-white">
        ...
        <section
          id="hero"
          className="relative bg-gradient-to-br from-gray-50 to-white py-20 px-4 overflow-hidden"
        >
              ...
              >
                ...
                <div className="text-lg text-gray-600 leading-relaxed space-y-4">
                  <p>
                    ...
                    to help businesses engage and convert high-value accounts
                    with precision. Our data-driven strategies focus on
                    identifying key decision-makers, creating personalized
                    outreach campaigns, and using multi-channel engagement to
                    drive meaningful interactions.
                  </p>
                  <p>
                    By aligning sales and marketing efforts, we ensure higher
                    conversion rates, improved customer relationships, and
                    accelerated revenue growth. With our tailored ABM solutions,
                    your business can achieve{" "}
                    <span className="font-bold text-gray-800">
                      greater efficiency, better ROI, and long-term success
                    </span>
                    .
                  </p>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900">
                  Transform Your{" "}
                  <span className="text-emerald-400">B2B Strategy</span>
                </h2>

                <p className="text-lg text-gray-600 leading-relaxed">
                  Elevate your B2B marketing strategy with our precision-focused
                  account-based approach. We identify and engage high-value
                  prospects through personalized content and targeted outreach.
                  By aligning sales and marketing efforts toward specific
                  accounts, we create deeper connections with decision-makers
                ...
                <div className="grid grid-cols-3 gap-8 pt-8">
                  <div className="text-center group">
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-3xl font-bold text-gray-900 group-hover:text-emerald-400 transition-colors">
                        +92%
                      </span>
                    </div>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 group">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Pinpoint your ideal accounts using firmographic,
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 group">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Create personalized campaigns across multiple channels to
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 group">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Foster meaningful relationships through personalized content
                    and strategic outreach to enhance conversions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div
                className={`transform transition-all duration-500 ${
                  hoveredCard === "predictive" ? "scale-105 -translate-y-2" : ""
                }`}
              ...
              >
                <div className="bg-gradient-to-br from-emerald-400 to-green-500 rounded-2xl p-8 text-white h-full shadow-xl">
                  ...
                  <p className="mb-6 opacity-90">
                    Advanced AI-driven predictive analytics that forecast
                    potential high-value accounts with unprecedented accuracy
                    and insight.
                  </p>
              ...
              >
                <div className="bg-gradient-to-br from-teal-400 to-emerald-500 rounded-2xl p-8 text-white h-full shadow-xl">
                  ...
                  <p className="mb-6 opacity-90">
                    Create laser-focused marketing strategies that resonate
                    deeply with individual decision-makers across target
                    accounts.
                  </p>
                  <div className="flex justify-between items-center pt-4 border-t border-white/20">
                    <div>
              ...
              >
                <div className="bg-gradient-to-br from-green-400 to-teal-500 rounded-2xl p-8 text-white h-full shadow-xl">
                  ...
                  <p className="mb-6 opacity-90">
                    Deep-dive strategic insights that uncover hidden
                    opportunities and competitive advantages in your target
                    market landscape.
                  </p>
                  <div className="flex justify-between items-center pt-4 border-t border-white/20">
                    <div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
              <div className="grid grid-cols-3 bg-gray-50">
                ...
                <div className="p-6 bg-emerald-400 text-white text-center font-bold text-lg">
                  Traditional
                </div>
                <div className="p-6 bg-gradient-to-r from-emerald-400 to-green-500 text-white text-center font-bold text-lg">
                  ABM
                </div>
              </div>
              ...
              {[
                {
                  label: "Approach",
                  traditional: "Broad, quantity-focused",
                  abm: "Narrow, quality-focused",
                },
                {
                  label: "Targeting",
                  traditional: "Industry/role based",
                  abm: "Specific accounts & people",
                },
                {
                  label: "Content",
                  traditional: "Generic, one-size-fits-all",
                  abm: "Hyper-personalized",
                },
                {
                  label: "ROI",
                  traditional: "Lower, harder to measure",
                  abm: "Higher, clearly measurable",
                },
              ].map((row, index) => (
                <div
                  key={index}
          ...
          <div className="max-w-7xl mx-auto space-y-12">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Monitor and optimize your account-based marketing campaigns with
                real-time insights and strategic objectives.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <div className="flex justify-between items-start  gap-8">
                    ...
                    <div className="w-full mt-12 max-w-sm">
                      ...
                      <div className="mt-26">
                        ...
                        <div className="w-[550px] bg-gray-200 rounded-full h-2">
                    ...
                    {/* Right: Metric List */}
                    <div className="flex flex-col mt-8 gap-8 pt-6 pr-2">
                      {/* Open Rate */}
                      <div>
                        <div className="text-emerald-500 text-sm font-medium">
                          45%
                        </div>
                        <div className="text-gray-700 text-lg">Open Rate</div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Account-Based Marketing is a strategic approach that aligns
                  marketing and sales efforts to target high-value accounts with
                ...
                <div className="space-y-6">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start group">
                        ...
                        <div>
                          ...
                          <span className="text-gray-600 ml-1">
                            Focus on high-potential accounts rather than broad
                            markets
                          </span>
                        </div>
                      </li>
                      <li className="flex items-start group">
                        ...
                        <div>
                          ...
                          <span className="text-gray-600 ml-1">
                            Tailor messaging to specific account needs and pain
                            points
                          </span>
                        </div>
                      </li>
                      ...
                      <li className="flex items-start group">
                        ...
                        <div>
                          ...
                          <span className="text-gray-600 ml-1">
                            Coordinated outreach across multiple platforms
                          </span>
                        </div>
                      </li>
                      <li className="flex items-start group">
                        ...
                        <div>
                          ...
                          <span className="text-gray-600 ml-1">
                            Measure success by account engagement rather than
                            lead volume
                          </span>
                        </div>
                      </li>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ABM delivers higher ROI than traditional marketing by
                      focusing resources on accounts most likely to convert and
                      provide significant lifetime value. It's particularly
                      effective for B2B companies with complex sales cycles and
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      <div className="flex items-start">
                        <div className="text-3xl font-bold text-emerald-400 mr-4 group-hover:scale-125 transition-transform duration-300">
                          90%
                        </div>
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 text-sm leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                            Prioritize acquiring high-value target accounts
                            through precision marketing strategies.
                          </p>
                        </div>
                      </div>
                      {hoveredObjective === 1 && (
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 text-sm leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                            Streamline and expedite the sales process for
                    ...
                    >
                      ...
                      {hoveredObjective === 3 && (
                        <div className="mt-4 flex items-center text-emerald-500 text-sm animate-fade-in">
                          ...
                          <span>
                            Expand and strengthen current partnerships
                          </span>
                        </div>
                      )}
                    </div>
